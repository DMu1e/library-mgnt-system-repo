...
#include "C:\Users\adame\coding_projects\Library_Management_system\Include\TransactionLogger.hpp"
...
void handleMemberOperations(Library &library)
{
...
void handleLibrarianOperations(Library &library)
{
...
int main()
{
    ...
    while (true)
    {
        ...
        {
        case 1:
            handleMemberOperations(library);
            break;
        case 2:
            handleLibrarianOperations(library);
            break;
        case 3:
